...
```json
{
  "answer": "HR 포털(hr.beyondcorp.com)에 로그인 후 '휴가신청' 메뉴에서 신청합니다.
최소 3일 전 신청이 원칙이고, 팀장 승인 후 확정됩니다.
당일 연차는 오전 9시 전까지 Slack으로 팀장님께 먼저 알리고, 사후에 포털에 등록하세요.
연차 잔여일수는 포털 대시보드에서 실시간 확인 가능합니다.
문의: 인사팀 김하늘 매니저 (내선: 2001, hanuel.kim@beyondcorp.com)"
}
```
